        ...
        if(DEFAULT_HTML_TAG.count(path_)) {
            ...
            if(tag == 0 || tag == 1) {
                ...
                if(UserVerify(post_["username"], post_["password"], isLogin)) {
                    LOG_DEBUG("UserVerify success: %s %s", post_["username"].c_str(), post_["password"].c_str());
                    path_ = "/welcome.html";
                } 
                else {
                    LOG_DEBUG("UserVerify fail: %s %s", post_["username"].c_str(), post_["password"].c_str());
                    path_ = "/error.html";
                }
            }
        }
